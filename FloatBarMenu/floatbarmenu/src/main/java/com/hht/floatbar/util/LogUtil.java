...
import com.hht.floatbar.FloatingBarApplication;
 ...
 * @time 2017/12/14 10:43
 * @describe
 */
public class LogUtil {

    public static final String _TAG = "OEM_FloatBar";
    ...
    static{
        if (isApkDebugable(FloatingBarApplication.getInstance())){
            isEshow=true;
            isWshow=true;
            isIshow=true;
            isDshow=true;
